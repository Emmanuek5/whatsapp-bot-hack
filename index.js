  ...
  if (msg.body == "1") {
    ...
    if (msg.body == "Agro 1") {
      ...
      if (msg.body == "M1") {
        ...
        msg.reply(
          "Thank You For You Order. The Closest Dispatch Rider Will Contact You With The Details Of Your Order. "
        );
        mail.sendmail(
          email,
          "New Order HAS Been Placed For Meat 1kg At Price N1200 ",
          "New Order",
        ...
        if (msg.body == "M2") {
          ...
          mail.sendmail(
            email,
            "New Order HAS Been Placed For Meat 5kg At Price N1500 ",
            "New Order",
            "fsgsolutions@gmail.com"
          );
          client.sendMessage(
          ...
          if (msg.body == "C3") {
            ...
            mail.sendmail(
              email,
              "New Order HAS Been Placed For Chicken 1kg At Price N2000 ",
              "New Order"
            );
            client.sendMessage(
              chatId,
            ...
            if (msg.body == "C4") {
              ...
              mail.sendmail(
                email,
                "New Order HAS Been Placed For Chicken 5kg At Price N3000 ",
                "New Order"
              );
            } else {
              if (msg.body == "4") {
                client.sendMessage(
                  msg.from,
                  "Dear Customer, Please Send Your Message To The Support Team. We Will Get Back To You As Soon As Possible. Thank You For Choosing FSG Solutions. If You Want Yo Speak To An Agent  Please Enter YES"
                );
              } else {
                if (msg.body == "YES") {
                  client.sendMessage(
